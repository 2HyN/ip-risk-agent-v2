...
GROUND_TRUTH: dict[str, bool] = {
    ...
    "drone-delivery-route-optimization.md": True,
    "ev-charging-load-balancing.md": True,
    "indoor-positioning-ble-triangulation.md": True,
    "gesture-recognition-ui-control.md": True,
    "predictive-maintenance-vibration-analysis.md": True,
    "smart-farm-irrigation-control.md": True,
    "elevator-group-dispatch-control.md": True,
    "wind-turbine-pitch-control.md": True,
    "wafer-defect-detection-imaging.md": True,
    "adaptive-video-bitrate-streaming.md": True,
    "mobile-payment-fraud-detection.md": True,
    "lane-keeping-assist-sensor-fusion.md": True,
    "3d-printer-quality-monitoring.md": True,
    "waste-sorting-robot-vision.md": True,
    "water-treatment-dosing-control.md": True,
    "adaptive-traffic-signal-control.md": True,
    "call-center-qa-auto-scoring.md": True,
    "warehouse-robot-fleet-coordination.md": True,
    "smart-meter-anomaly-detection.md": True,
    "face-recognition-access-control.md": True,
    "quarterly-marketing-campaign-plan.md": False,
    "employee-benefits-policy-notice.md": False,
    "team-workshop-retrospective-notes.md": False,
    "job-posting-draft-backend-engineer.md": False,
    "budget-execution-summary-memo.md": False,
}
